...
<head>
    ...
    <!-- Title -->
    <title>Register || Website Sistem Informasi UKM Pramuka</title>
    <!-- Styles -->
...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <p class="auth-description">Silahkan register untuk melanjutkan.</p>
            <form action="{{ route('registerPost') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="auth-credentials">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label for="signInEmail" class="form-label">Photo</label>
                            <input type="file" name="photo" class="form-control m-b-md" id="signInEmail"
                                aria-describedby="signInEmail" placeholder="Masukkan Nama Lengkap" required>
                        </div>
                        <div class="col-6">
                            <label for="signInEmail" class="form-label">Nama Lengkap</label>
                            <input type="text" name="name" class="form-control m-b-md" id="signInEmail"
                                aria-describedby="signInEmail" placeholder="Masukkan Nama Lengkap" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <label for="signInEmail" class="form-label">NIM</label>
                            <input type="text" name="nim" class="form-control m-b-md" id="signInEmail"
                                aria-describedby="signInEmail" placeholder="Masukkan NIM" required>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="password" name="password" class="form-control" id="signInPassword"
                                aria-describedby="signInPassword" placeholder="Masukkan Password" required>
                        </div>
                        <div class="col-6">
                            <label for="signInPassword" class="form-label">Konfirmasi Password</label>
                            <input type="password" name="password_confirmation" class="form-control" id="signInPassword"
                                aria-describedby="signInPassword" placeholder="Masukkan Password" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="auth-submit">
                    ...
                    <a href="{{ route('login') }}" class="auth-forgot-password float-end btn btn-secondary">Login</a>
                </div>
            </form>
